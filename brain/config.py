...
# --- Notifiche Telegram (kill-switch) -------------------------------------
# 2026-09-12: DISATTIVATE. Il Brain inviava il verdetto TREND vs GRID ogni
# ~60s perche' il flag di idempotenza (trend_validation_done) veniva
# cancellato dal save_state del watchdog (main.py).
# Riattivabili con BRAIN_TELEGRAM=1 nell'environment della unit
# denaro-brain.service.
import os as _os
TELEGRAM_ENABLED = _os.getenv("BRAIN_TELEGRAM", "0") == "1"
