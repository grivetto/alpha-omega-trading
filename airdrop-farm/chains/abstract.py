...
class AbstractConnector(BaseConnector):
    def __init__(self, rpc_url: str, gas_price_gwei: int = 0):
        super().__init__(rpc_url, chain_id=1101, name="abstract", gas_price_gwei=gas_price_gwei)
    ...
    def get_protocol_tvl(self) -> Dict[str, float]:
        return {
            "abstract_dex": 50_000_000,
            "nft_market": 20_000_000,
        }
