...
declare -A HOST_SERVICE=(
  ["alpha-omega-nuvola"]="local|denaro-node-nuvola-trade"
  ["nuvola"]="local|denaro-node-nuvola-trade"
  ["alpha-omega-marcodg1"]="MARCODG1|denaro-node-marcodg1-xrp"
  ["marcodg1"]="MARCODG1|denaro-node-marcodg1-xrp"
  ["MARCODG1"]="MARCODG1|denaro-node-marcodg1-xrp"
  ["alpha-omega-mc2"]="mc2|denaro-node-mc2"
  ["alpha-omega-node-mc2"]="mc2|denaro-node-mc2"
  ["alpha-omega-bot-sol-eur"]="mc2|denaro-node-mc2"
  ["alpha-omega-bot-doge-eur"]="mc2|denaro-node-mc2"
  ["alpha-omega-bot-eth-eur"]="mc2|denaro-node-mc2"
  ["alpha-omega-bot-ada-eur"]="MARCODG1|denaro-node-marcodg1-xrp"
  ["mc2"]="mc2|denaro-node-mc2"
)
...
restart_service() {
  ...
  local action=""
  if [ "$node" = "local" ]; then
    action="sudo -n systemctl restart $service"
  elif [ "$node" = "mc2" ]; then
    action="ssh -o ConnectTimeout=8 -o BatchMode=yes sergio@mc2 'export XDG_RUNTIME_DIR=/run/user/1000; systemctl --user restart $service'"
  else
