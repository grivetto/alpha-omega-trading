...
TRADING_PAIRS = [
    ...
    'FILUSDT', 'AAVEUSDT', 'APTUSDT', 'NEARUSDT', 'ARBUSDT',
    # 21-30
    'OPUSDT', 'MKRUSDT', 'INJUSDT', 'STXUSDT', 'RUNEUSDT',
    'SUIUSDT', 'FETUSDT', 'IMXUSDT', 'GRTUSDT', 'ALGOUSDT',
    # 31-40
    'VETUSDT', 'THETAUSDT', 'AXSUSDT', 'SNXUSDT', 'MANAUSDT',
    'SANDUSDT', 'FLOWUSDT', 'ICPUSDT', 'EOSUSDT', 'XTZUSDT',
    # 41-50
    'CHZUSDT', 'LDOUSDT', 'QNTUSDT', 'BSVUSDT', 'BCHUSDT',
    'EGLDUSDT', 'ZILUSDT', 'ENJUSDT', 'NEOUSDT', 'DASHUSDT',
    # 51-60
    'COMPUSDT', 'YFIUSDT', 'UMAUSDT', 'ZECUSDT', 'KNCUSDT',
    '1INCHUSDT', 'CRVUSDT', 'CAKEUSDT', 'TRXUSDT', 'FTMUSDT',
    # 61-70
    'ROSEUSDT', 'CELOUSDT', 'LRCUSDT', 'OMGUSDT', 'BATUSDT',
    'ANKRUSDT', 'STORJUSDT', 'COTIUSDT', 'HOTUSDT', 'GMTUSDT',
    # 71-80
    'LDOUSDT', 'RIFUSDT', 'XTZUSDT', 'KLAYUSDT', 'MINAUSDT',
    'BLZUSDT', 'AUDIOUSDT', 'REEFUSDT', 'SRMUSDT', 'COCOSUSDT',
    # 81-90
    'ALICEUSDT', 'ACHUSDT', 'SKLUSDT', 'IOTXUSDT', 'NKNUSDT',
    'ANTUSDT', 'DATAUSDT', 'DGBUSDT', '1000SATSUSDT', 'ORDIUSDT',
    # 91-100
    'WLDUSDT', 'STRKUSDT', 'PEOPLEUSDT', 'FTTUSDT', 'RUNEUSDT',
    'CAKEUSDT', 'BAKEUSDT', 'COTIUSDT', 'REEFUSDT', 'ATAUSDT'
]
