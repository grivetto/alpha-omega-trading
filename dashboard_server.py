...
<body class="crt-flicker">
    ...
    <header>
        ...
        <div style="margin-top: 15px; font-size: 1.2rem; color: #00ffcc; text-shadow: 0 0 10px #00ffcc; font-weight: bold; border: 1px solid #00ffcc; display: inline-block; padding: 5px 15px; background: rgba(0, 255, 204, 0.1); border-radius: 4px;">
