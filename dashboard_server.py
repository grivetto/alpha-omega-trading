...
<body>
    ...
    <div class="container">
        ...
        <div style="color: #39ff14; text-align: center; font-weight: bold; border: 1px dashed #39ff14; padding: 5px; margin-bottom: 10px;">⚙️ PROTOCOLLO TRINITY: Online (DCA, Funding, MEV)</div>
