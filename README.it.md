...
| **🔑 Validazione Chiavi API** | **2026-08-22** | **Test completi delle chiavi API su tutti i nodi.** Chiavi Kraken su NUVOLA (2 coppie funzionanti, EUR=22.20), chiavi OKX su MARCODG1 (stabili da 2+ giorni). Fix problemi base64 padding e IP whitelist. Tutti gli exchange operativi. |
| **🤝 Compatibilità Denaro-Atlas** | **2026-08-22** | **Layer di compatibilità ufficiale tra Denaro (legacy stabile) e Atlas (next-gen gestito da Hermes).** Entrambi i sistemi coesistono sugli stessi nodi con chiavi API separate. Denaro esegue solo-engine (Kraken/OKX grid), Atlas via Hermes AI. Nessun conflitto con isolamento chiavi. Stato operativo completo su NUVOLA e MARCODG1. |
